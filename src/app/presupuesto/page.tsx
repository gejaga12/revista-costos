      ...
      <div className="w-1/4 bg-white dark:bg-gray-800 p-4 shadow-lg">
        ...
        <ul>
          {categories.map((category, index) => (
            <li
              key={index}
              className={`p-2 cursor-pointer ${selectedCategory === category ? 'bg-blue-500 text-white' : 'text-black dark:text-white'}`}
            ...
            {selectedItems.length === 0 ? (
              ...
              <ul>
                {selectedItems.map((item, index) => (
                  <li key={index} className="flex justify-between items-center p-2 bg-gray-100 dark:bg-gray-700 mb-2 rounded">
